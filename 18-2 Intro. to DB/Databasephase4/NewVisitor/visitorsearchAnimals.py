...
from NewVisitor.visitoranimalDetail import Ui_animalDetail as animalDetail
...
class Ui_searchAnimals(object):
    ...
    def animalSearch(self):
        ...
        query = "SELECT Name, Species, exhibit, age, type from zoo.Animal where name like '%{}%' AND species like '%{}%' AND age >= {} AND age <= {} AND type like '%{}%' and exhibit like '%{}%';".format(
